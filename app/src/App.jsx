...
import StudentCourseClassroom from './pages/studentDashboard/StudentCourseClassroom';
...
const App = () => {
  return (
    ...
    <Routes>
      ...
      <Route path="/student/course/:courseId/classroom" element={<StudentCourseClassroom />} />
